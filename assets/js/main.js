...
function readMore(section, link, arrow) {
	...
	var lnkText = document.getElementById(link);
	var arwRead = document.getElementById(arrow);

	if (lnkText.innerHTML === "Click to hide project") {
		lnkText.innerHTML = "Click to read more about this project";
		moreText.style.display = "none";
	arwRead.setAttribute("class", "arrowread down")
	} else {
		lnkText.innerHTML = "Click to hide project";
		moreText.style.display = "inline";
		arwRead.setAttribute("class", "arrowread up")
	}
}
